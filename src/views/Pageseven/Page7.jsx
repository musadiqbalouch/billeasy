    ...
    <div className=' w-full  pt-20 pb-10 flex flex-row m-auto '>
      <div className='relative sm:h:75 sm:w-150 lg:h-75 lg:w-235  m-auto  bg-no-repeat bg-cover bg-center  rounded-2xl items-center justify-center xl:h-75 xl:w-285 '
        ...
        <div className=' h-40 w-full items-center justify-center p-5 xl:h-40 xl:w-150  xl:p-15 '>
          ...
          <button className=' text-[rgba(12,113,224,1)] text-xs flex flex-row flex-nowrap h-6 w-28 bg-white rounded-2xl 
        ...
        <div className='flex flex-row   relative left10 sm:ml-30 lg:ml-60 lg:bottom-60 xl:flex xl:flex-row xl:ml-80  xl:relative xl:bottom-64 '>
          ...
          <img className="object-cover h-32 w-32 relative right-5 bottom-4 sm:right-12 sm:h-40 sm:w-38 md:h-43 md:w-42 md:right-11 lg:h-85 lg:w-85 lg:right-20  xl:h-100 xl:w-100 xl:relative xl:right-30" src={tabletimage} />
        </div>
      </div>
    </div>
  )
