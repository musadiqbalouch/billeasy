...
const Header = () => {
    return (
        <div className=" h-172 bg-no-repeat bg-center bg-cover flex flex-col bg-gradient-to-b from-white via-white/50 to-white " 
        style={{ backgroundImage: ` url(${img}) ` }}
        >
            <div>
                <div className='flex flex-row  justify-between h-20 w-100% '>
                    <div className=''>  <img className="h-15 w-40 ml-30 mt-2" src="src/assets/Billeasylogo.png" /></div>
                    <div className="flex flex-row  h-7 w-53 bg-blue-600 rounded-xl mr-30 mt-5 align-centre justify-center text-center ">  <h3 className='text-white text-lg font-normal '>Request Early Access</h3>
                        <FaLongArrowAltRight className='text-white mt-1.5 ml-1 h-5 w-5' /></div></div> </div>
            ...
            <div className='flex flex-row h-70 w-100%'>
                ...
                <div className='flex flex-col h-80 w-110 border-2 align-centre justify-center p-10 rounded-2xl ml-20 mt-20 gap-5 '>
                    <h2 className='text-4xl text-blue-600 font-semibold'>Request a Demo</h2>
                    <input className="outline-none border-b-2 border-blue-600 placeholder-[rgba(15, 15, 15, 0.3)]" type="text" placeholder='Your Name' />
                    <input className='outline-none border-b-2 border-blue-600' type="email" placeholder='Your Email' />
                    <input className="outline-none border-b-2 border-blue-600 " type="tel" placeholder='Enter Your Number' />
                    <input className="outline-none border-b-2 border-blue-600 " type="text" placeholder='Company Name' />
                    <button className='flex flex-row  h-20 w-30 bg-blue-600 text-white  rounded-2xl p-2 align-centre justify-center text-center '>Submit  <HiMiniArrowUturnRight className='mt-1 ml-2' />   </button>
                </div>
            </div>
