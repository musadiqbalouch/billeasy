  ...
  return (
    <div className=' w-full  '>
      <div className='container mx-auto'>
        <div className='items-center justify-center  flex flex-col mx-auto  pt10 lg:flex-row lg:gap-30 xl:gap-100 xl:p-10 xl:flex-row'>
          <div className=' xl:h-30 xl:w-90 lg:w-80 mx-auto justify-center items-center  '>
            <img className=' h-10 w-40 object-cover mb-4 mx-auto lg:mx-0 xl:h-15 xl:w-55  xl:mb-4' src={logo} />
            <p className=' text-xs p-5 lg:p-0 font-medium text-center sm:text-base lg:text-base/4 lg:text-start  xl:text-base/4 xl:font-medium'>At Bill Easy, we’re committed  to simplifying your financial management  so you can focus on what matters mostbr  —growing your business.</p>
