...
const Integrated = () => {
    const items = [
        "Schedule recurring invoices and auto-apply taxes or late fees", "Auto-generate invoices from approved estimates or templates",
        "Reduce human error and get paid faster with less follow-up.", "Set smart reminders for due, overdue, or partial payments."
    ]
    return (
        <div>
